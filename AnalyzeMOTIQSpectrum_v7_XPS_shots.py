...
avg_phase_in_a_cycle=SegmentsPerFile*phase_in_a_cycle/numAtomCycles-phase_slope*ch1_x[2*scansize:numMeasurementsTotal]
# m,b = fit_to_a_line(ch1_x[2*scansize:numMeasurementsTotal],avg_phase_in_a_cycle)
# print(m,b)
