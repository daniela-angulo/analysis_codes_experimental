...
class Spectrum_info_class:
	def __init__(self, filename):
		...
		self.Mem = tdms_file['Raw Data'].properties["Mem"]
		self.Seg = tdms_file['Raw Data'].properties["Seg"]
		self.Pre = tdms_file['Raw Data'].properties["Pre"]
		self.Post = tdms_file['Raw Data'].properties["Post"]
		self.num_segments = int(self.Mem/self.Seg)
		self.sampling_rate = tdms_file['Raw Data'].properties["Sampling Rate (kHz)"]
		self.trigger_source = tdms_file['Raw Data'].properties["Trigger Source"]
		#channel info
		self.ch0_voltage_range = tdms_file['Raw Data']['Channel 0'].properties["Input Range "] #the space is needed here
		self.ch1_voltage_range = tdms_file['Raw Data']['Channel 1'].properties["Input Range "] #the space is needed here
		self.ch2_voltage_range = tdms_file['Raw Data']['Channel 2'].properties["Input Range "] #the space is needed here
		self.ch3_voltage_range = tdms_file['Raw Data']['Channel 3'].properties["Input Range "] #the space is needed here
		...
		self.ch0_termination = tdms_file['Raw Data']['Channel 0'].properties["Termination"]
		self.ch1_termination = tdms_file['Raw Data']['Channel 1'].properties["Termination"]
		self.ch2_termination = tdms_file['Raw Data']['Channel 2'].properties["Termination"]
		self.ch3_termination = tdms_file['Raw Data']['Channel 3'].properties["Termination"]
		self.ch0_enabled = tdms_file['Raw Data']['Channel 0'].properties["Enable"]
		self.ch1_enabled = tdms_file['Raw Data']['Channel 1'].properties["Enable"]
		self.ch2_enabled = tdms_file['Raw Data']['Channel 2'].properties["Enable"]
		self.ch3_enabled = tdms_file['Raw Data']['Channel 3'].properties["Enable"]
		self.num_channels_enabled = self.ch0_enabled+self.ch1_enabled+self.ch2_enabled+self.ch3_enabled
		#multipurpose channels
		self.X0_mode = tdms_file['Raw Data'].properties["X0 Mode"]
		self.X1_mode = tdms_file['Raw Data'].properties["X1 Mode"]
		self.X2_mode = tdms_file['Raw Data'].properties["X2 Mode"]
		self.X3_mode = tdms_file['Raw Data'].properties["X3 Mode"]	
